...
function Hero() {
  return (
    <div
      id="home"
      className="max-w-screen h-screen relative font-Teachers overflow-hidden"
    >
      <img
...
function Main() {
  ...
  return (
    <main className="px-8 flex flex-col justify-center text-center text-gray-300 h-full gap-5">
      ...
      <div className="w-full sm:w-2/3 lg:w-1/3 sm:mx-auto">
        <form
          onSubmit={(e) => handleEmailSubmit(e)}
          className="grid sm:grid-cols-3 w-full shadow-lg rounded-xl"
        >
          <input
            type="text"
            name="email"
      ...
      <div className="-z-10 absolute top-1/2 hidden xl:flex -translate-y-1/2 items-center justify-between w-full px-8 sm:px-14 sm:pr-24">
